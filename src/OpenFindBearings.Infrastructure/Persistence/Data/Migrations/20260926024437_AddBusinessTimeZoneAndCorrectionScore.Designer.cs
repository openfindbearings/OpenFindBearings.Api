...
namespace OpenFindBearings.Infrastructure.Persistence.Data.Migrations
{
    ...
    [Migration("20260926024437_AddBusinessTimeZoneAndCorrectionScore")]
    partial class AddBusinessTimeZoneAndCorrectionScore
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenFindBearings.Domain.Aggregates.Merchant", b =>
                {
                    ...
                    b.Property<bool>("VerifyRequested")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("OpenFindBearings.Domain.Aggregates.SourcingDemand", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SourcingDemands", (string)null);
                });
            ...
            modelBuilder.Entity("OpenFindBearings.Domain.Entities.MerchantDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OpenFindBearings.Domain.Entities.MerchantMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MerchantMembers", (string)null);
                });
            ...
            modelBuilder.Entity("OpenFindBearings.Domain.Entities.PointAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("ConsecutiveCheckinDays")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
                    ...
                    b.ToTable("PointAccounts", (string)null);
                });

            modelBuilder.Entity("OpenFindBearings.Domain.Entities.PointGrantRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PointGrantRules", (string)null);
                });

            modelBuilder.Entity("OpenFindBearings.Domain.Entities.PointRewardClaim", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("FirstClaimerUserId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PointRewardClaims", (string)null);
                });

            modelBuilder.Entity("OpenFindBearings.Domain.Entities.PointTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "GrantType", "CreatedAt")
            ...
            modelBuilder.Entity("OpenFindBearings.Domain.Entities.SourcingResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DemandId", "MerchantId")
                        .IsUnique()
                        .HasDatabaseName("UX_SourcingResponses_Demand_Merchant");

                    b.ToTable("SourcingResponses", (string)null);
                });
            ...
            modelBuilder.Entity("OpenFindBearings.Domain.Entities.StaffInvitation", b =>
                {
                    ...
                    b.Property<bool>("InitiatorJoins")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
            ...
            modelBuilder.Entity("OpenFindBearings.Domain.Entities.BearingInterchange", b =>
                {
                    ...
                    b.OwnsOne("OpenFindBearings.Domain.ValueObjects.DataSource", "DataSource", b1 =>
                        {
                            b1.Property<Guid>("BearingInterchangeId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("BearingInterchangeId");

                            b1.ToTable("BearingInterchanges");

                            b1.WithOwner()
                                .HasForeignKey("BearingInterchangeId");
                        });
