...
4. `AuditLogMiddleware` — 审计日志（拦截 POST/PUT/PATCH/DELETE，跳过 GET/HEAD/OPTIONS 及 /health、/swagger 路径；记录 Action/HttpMethod/RequestPath/StatusCode/DurationMs/OperatorId 等字段）
5. 认证 → 授权 → CORS → 端点映射
